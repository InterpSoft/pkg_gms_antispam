...
<form action="<?php echo Route::_('index.php?option=com_gmsantispam&view=logs'); ?>" method="post" name="adminForm"
    id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <h1>Antispam-Logs</h1>
                <form action="<?php echo Route::_('index.php?option=com_gmsantispam&view=logs'); ?>" method="post"
