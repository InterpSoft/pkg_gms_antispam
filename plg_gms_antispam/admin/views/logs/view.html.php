...
class HoneypotViewLogs extends HtmlView
{
    protected $logs;
    ...
    {
        JToolbarHelper::title(JText::_('PLG_CAPTCHA_HONEYPOT_LOGS'), 'list-2');
...
/**
 * View to edit Honeypot Logs
 *
 * @since  1.0
 */
class HoneypotViewLogs extends JViewLegacy
{
    /**
     * Display the view
     *
